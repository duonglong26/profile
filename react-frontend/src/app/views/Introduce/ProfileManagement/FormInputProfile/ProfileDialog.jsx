...
import {
  newProfile,
  uploadImage,
} from "../../ProfileManagement/ProfileService";
...
function ProfileDialog() {
  ...
  useEffect(() => {
    ...
    if (providerValue.currentProfileEdit) {
      ...
      // Personal Infor
      setFirstName(
        obj?.personalInformation?.firstName
          ? obj?.personalInformation?.firstName
          : ""
      );
      setLastName(
        obj?.personalInformation?.lastName
          ? obj?.personalInformation?.lastName
          : ""
      );
      setJob(
        obj?.personalInformation?.job ? obj?.personalInformation?.job : ""
      );
      setAddress(
        obj?.personalInformation?.address
          ? obj?.personalInformation?.address
          : ""
      );
      setLinkFacebook(
        obj?.personalInformation?.linkFacebook
          ? obj?.personalInformation?.linkFacebook
          : ""
      );
      setLinkInstagram(
        obj?.personalInformation?.linkInstagram
          ? obj?.personalInformation?.linkInstagram
          : ""
      );
      setLinkTwitter(
        obj?.personalInformation?.linkTwitter
          ? obj?.personalInformation?.linkTwitter
          : ""
      );
      setLinkGithub(
        obj?.personalInformation?.linkGithub
          ? obj?.personalInformation?.linkGithub
          : ""
      );
      setEmail(
        obj?.personalInformation?.email ? obj?.personalInformation?.email : ""
      );
      setPhone(
        obj?.personalInformation?.phone ? obj?.personalInformation?.phone : ""
      );
      // Introduce
      setSentenceWelcome(
        obj?.introduce?.sentenceWelcome ? obj?.introduce?.sentenceWelcome : ""
      );
      setIntroductionUser(
        obj?.introduce?.introductionUser ? obj?.introduce?.introductionUser : ""
      );
      setTitleAboutMe(
        obj?.introduce?.titleAboutMe ? obj?.introduce?.titleAboutMe : ""
      );
      setTask(obj?.introduce?.task ? obj?.introduce?.task : "");
      setDescriptionTask(
        obj?.introduce?.descriptionTask ? obj?.introduce?.descriptionTask : ""
      );
      //
      if (obj?.educationList) setListSchool(obj.educationList);
      if (obj?.skillList) setSkillList(obj.skillList);
      if (obj?.projectList) setProjectList(obj.projectList);
    }
  }, []);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.dialog}>
        ...
        {/* Title */}
        {!id && <h2 className={styles.title}>NEW PROFILE</h2>}
        {id && <h2 className={styles.title}>EDIT PROFILE</h2>}
        {/* Content */}
        <div className={styles.content}>
          ...
          <div className={styles.contentBox}>
            ...
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "firstName")
                }
              />
            ...
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "lastName")
                }
              />
            ...
            <div className={styles.form}>
              ...
              />
              <label className={styles.formLabel}>Job</label>
            </div>
            {/* Address */}
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "address")
                }
              />
            ...
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "linkFacebook")
                }
              />
              <label className={styles.formLabel}>Link Facebook</label>
            </div>
            {/* LinkInstagram */}
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "linkInstagram")
                }
              />
              <label className={styles.formLabel}>Link Instagram</label>
            </div>
            {/* LinkTwitter */}
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "linkTwitter")
                }
              />
              <label className={styles.formLabel}>Link Twitter</label>
            </div>
            {/* LinkGithub */}
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "linkGithub")
                }
              />
              <label className={styles.formLabel}>Link Github</label>
            </div>
            {/* Email */}
            <div className={styles.form}>
              <input
            ...
            <div className={styles.form}>
              ...
              />
              <label className={styles.formLabel}>Picture Yourself</label>
            </div>
          </div>
          ...
          <div className={styles.contentBox}>
            ...
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "sentenceWelcome")
                }
              />
            ...
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "introductionUser")
                }
              />
            ...
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "titleAboutMe")
                }
              />
            ...
            <div className={styles.form}>
              <input
                ...
                onChange={(input) =>
                  handleChange(input.target.value, "descriptionTask")
                }
              />
          ...
          <div className={styles.contentBox}>
              ...
              <div className={styles.item} key={index}>
                ...
                <div className={styles.form}>
                  <input
                    ...
                    onChange={(input) =>
                      handleChangeSchoolData(input.target.value, "major", index)
                    }
                  />
                ...
                >
                  <FaMinusCircle className={styles.iconTrashCan} />
                </div>
              </div>
            ))}
            ...
            <div className={styles.boxAddItem}>
              <div className={styles.boxItem} onClick={() => handleAddSchool()}>
              ...
              <div className={styles.contentBox} key={index}>
                ...
                >
                  <input
                    ...
                    onChange={(input) =>
                      handleChangeSkill(input.target.value, "skillName", index)
                    }
                  />
                ...
                <div className={styles.listIcon}>
                  ...
                  <div
                    ...
                    title="Remove skill"
                  >
                    <FaMinusCircle className={styles.iconMinus} />
                  </div>
                </div>
              ...
              <div className={styles.item} key={index}>
                ...
                <div className={styles.form}>
                  <input
                    ...
                    onChange={(input) =>
                      handleChangeProject(input.target.value, "name", index)
                    }
                  />
